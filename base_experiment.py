...
def _extract_json(text: str) -> dict:
    """Extract a JSON object from a model output, even if wrapped in code fences or extra prose."""
...
def _normalize_and_validate(d: dict) -> dict:
    ...
    # Normalize keys like "Agent Name", "agentName" → "agent_name"
    def norm(k): 
    ...
    try:
        ...
        # Try to extract leading integer if the model returned like "Step 3"
...
def call_openai(prompt, model="gpt-4o-mini"):
    ...
    # Add ultra-clear formatting instruction
    user_prompt = (
        prompt
        + "\n\nFORMAT INSTRUCTIONS:\n"
    ...
    try:
        ...
        # Helpful debugging so you can see what the model actually returned
